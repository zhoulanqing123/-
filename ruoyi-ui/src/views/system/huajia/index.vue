<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="当日营业额" prop="getMoney">
        <el-input
          v-model="queryParams.getMoney"
      ...
      <el-form-item label="当日进货金额" prop="putMoney">
        <el-input
          v-model="queryParams.putMoney"
          placeholder="请输入当日进货金额"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:huajia:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:huajia:export']"
        >导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="huajiaList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="id" align="center" prop="id" />
      <el-table-column label="店铺名称" align="center" prop="name" />
      <el-table-column label="当日营业额" align="center" prop="getMoney" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="当日营业额" prop="getMoney">
          <el-input v-model="form.getMoney" placeholder="请输入当日营业额" />
        </el-form-item>
        <el-form-item label="当日进货金额" prop="putMoney">
...
<script>
import { listHuajia, getHuajia, delHuajia, addHuajia, updateHuajia } from "@/api/system/huajia";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/huajia/export', {
        ...this.queryParams
